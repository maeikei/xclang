...
void XClangOptions::parseArgs(void)
{
    try {
        ...
        desc.add_options()
            ...
            (",D",value(&m_D),"   <macro>              Predefine the specified macro")
            (",Eonly","                    Just run preprocessor, no output (for timings)")
            (",E","                        Run preprocessor, emit preprocessed file")
            (",F",value(&m_F),"   <directory>          Add directory to framework include search path")
            (",H","                        Show header includes and nesting depth")
            (",I",value(&m_I),"   <directory>          Add directory to include search path")
            (",MG","                       Add missing headers to dependency list")
            (",MP","                       Create phony target for each dependency (other than main file)")
            (",MQ",value(&m_MQ),"   <value>             Specify target to quote for dependency")
            (",MT",value(&m_MT),"   <value>             Specify target for dependency")
            (",Os","                       Optimize for size")
            (",Oz","                       Optimize for size, regardless of performance")
            (",O",value(&m_O),"                 Optimization level")
            (",P","                        Disable linemarker output in -E mode")
            (",S","                        Emit native assembly code")
            (",U",value(&m_U),"   <macro>              Undefine the specified macro")
            (",Wlarge-by-value-copy",value(&m_Wlarge_by_value_copy),"   <value>                          Warn if a function definition returns or accepts an object larger in bytes that a given value")
            (",Wno-rewrite-macros","       Silence ObjC rewriting warnings")
            (",add-plugin",value(&m_add_plugin),"   <name>      Use the named plugin action in addition to the default action")
            (",analyze-function",value(&m_analyze_function),"   <value>                          Run analysis on specific function")
            (",analyzer-checker-help","    Display the list of analyzer checkers that are available")
            (",analyzer-checker",value(&m_analyzer_checker),"   <value>                          Choose analyzer checkers to enable")
            (",analyzer-constraints",value(&m_analyzer_constraints),"   <value>                          Source Code Analysis - Symbolic Constraint Engines")
            (",analyzer-disable-checker",value(&m_analyzer_disable_checker),"   <value>                          Choose analyzer checkers to disable")
            ...
            (",analyzer-inline-max-function-size",value(&m_analyzer_inline_max_function_size),"   <value>                          Bound on the number of basic blocks in an inlined function (200 by default)")
            (",analyzer-inline-max-stack-depth",value(&m_analyzer_inline_max_stack_depth),"   <value>                          Bound on stack depth while inlining (4 by default)")
            (",analyzer-inlining-mode",value(&m_analyzer_inlining_mode),"   <value>                          Specify the function selection heuristic used during inlining")
            (",analyzer-ipa",value(&m_analyzer_ipa),"   <value>   Specify the inter-procedural analysis mode")
            (",analyzer-max-loop",value(&m_analyzer_max_loop),"   <value>                          The maximum number of times the analyzer will go through a loop")
            (",analyzer-max-nodes",value(&m_analyzer_max_nodes),"   <value>                          The maximum number of nodes the analyzer can generate (150000 default, 0 = no limit)")
            ...
            (",analyzer-output",value(&m_analyzer_output),"   <value>                          Source Code Analysis - Output Options")
            (",analyzer-purge",value(&m_analyzer_purge),"   <value> Source Code Analysis - Dead Symbol Removal Frequency")
            (",analyzer-stats","           Print internal analyzer statistics.")
            (",analyzer-store",value(&m_analyzer_store),"   <value> Source Code Analysis - Abstract Memory Store Models")
            ...
            (",backend-option",value(&m_backend_option),"   <value> Additional arguments to forward to LLVM backend (during code gen)")
            (",c-isystem",value(&m_c_isystem),"   <directory>  Add directory to the C SYSTEM include search path")
            ...
            (",chain-include",value(&m_chain_include),"   <file>   Include and chain a header file after turning it into PCH")
            ...
            (",cl-std",value(&m_cl_std),"           OpenCL language standard to compile for")
            ...
            (",code-completion-at",value(&m_code_completion_at),"   <file>:<line>:<column>                          Dump code-completion information at a location")
            ...
            (",coverage-file",value(&m_coverage_file),"   <value>  Emit coverage data to this filename. The extension will be replaced.")
            (",cxx-abi",value(&m_cxx_abi),"   <value>        Target a particular C++ ABI type")
            (",cxx-isystem",value(&m_cxx_isystem),"   <directory>                          Add directory to the C++ SYSTEM include search path")
            (",dD","                       Print macro definitions in -E mode in addition to normal output")
            (",dM","                       Print macro definitions in -E mode instead of normal output")
            (",dependency-dot",value(&m_dependency_dot),"   <value> Filename to write DOT-formatted header dependencies to")
            (",dependency-file",value(&m_dependency_file),"   <value>                          Filename (or -) to write dependency output to")
            (",detailed-preprocessing-record","                            include a detailed record of preprocessing actions")
            (",diagnostic-log-file",value(&m_diagnostic_log_file),"   <value>                          Filename (or -) to log diagnostics to")
            ...
            (",dump-build-information",value(&m_dump_build_information),"   <filename>                          output a dump of some build information to a file")
            ...
            (",dwarf-debug-flags",value(&m_dwarf_debug_flags),"   <value>                          The string to embed in the Dwarf debug flags record.")
            ...
            (",error-on-deserialized-decl",value(&m_error_on_deserialized_decl),"   <value>                          Emit error if a specific declaration is deserialized from PCH, for testing")
            ...
            (",fconstexpr-backtrace-limit",value(&m_fconstexpr_backtrace_limit),"   <N>                          Set the maximum number of entries to print in a constexpr evaluation backtrace (0 = no limit).")
            (",fconstexpr-depth",value(&m_fconstexpr_depth),"   <value>                          Maximum depth of recursive constexpr function calls")
            (",fcuda-is-device","          Generate code for CUDA device")
            (",fcxx-exceptions","          Enable C++ exceptions")
            (",fdata-sections","           Place each data in its own section (ELF Only)")
            (",fdebug-compilation-dir",value(&m_fdebug_compilation_dir),"   <value>                          The compilation directory to embed in the debug info.")
            ...
            (",fdiagnostics-format",value(&m_fdiagnostics_format),"   <value>                          Change diagnostic formatting to match IDE and command line tools")
            ...
            (",fdiagnostics-show-category",value(&m_fdiagnostics_show_category),"   <value>                          Print diagnostic category")
            ...
            (",ferror-limit",value(&m_ferror_limit),"   <N>       Set the maximum number of errors to emit before stopping (0 = no limit).")
            ...
            (",fixit",value(&m_fixit),"            Apply fix-it advice creating a file with the given suffix")
            (",fixit","                    Apply fix-it advice to the input source")
            (",fmacro-backtrace-limit",value(&m_fmacro_backtrace_limit),"   <N>                          Set the maximum number of entries to print in a macro expansion backtrace (0 = no limit).")
            (",fmath-errno","              Require math functions to indicate errors by setting errno")
            (",fmessage-length",value(&m_fmessage_length),"   <N>    Format message diagnostics so that they fit within N columns or fewer, when possible.")
            (",fmodule-cache-path",value(&m_fmodule_cache_path),"   <directory>                          Specify the module cache path")
            (",fmodule-name",value(&m_fmodule_name),"      Specify the name of the module to build")
            (",fmodules","                 Enable the 'modules' language feature")
            (",fms-compatibility","        Enable Microsoft compatibility mode")
            (",fms-extensions","           Accept some non-standard constructs supported by the Microsoft compiler")
            (",fmsc-version",value(&m_fmsc_version),"     Version of the Microsoft C/C++ compiler to report in _MSC_VER (0 = don't define it (default))")
            ...
            (",fobjc-arc-cxxlib",value(&m_fobjc_arc_cxxlib),"                            Objective-C++ Automatic Reference Counting standard library kind")
            ...
            (",fobjc-dispatch-method",value(&m_fobjc_dispatch_method),"                            Objective-C dispatch method to use")
            ...
            (",foverride-record-layout",value(&m_foverride_record_layout),"                            Override record layouts with those in the given file")
            (",fpack-struct",value(&m_fpack_struct),"   <value>   Specify the default maximum struct packing alignment")
            (",fpascal-strings","          Recognize and construct Pascal-style string literals")
            (",fshort-enums","             Allocate to an enum type only as many bytes as it needs for the declared range of possible values")
            (",fshort-wchar","             Force wchar_t to be a short unsigned int")
            (",fshow-column","             Include column number on diagnostics")
            (",fshow-overloads",value(&m_fshow_overloads),"                            Which overload candidates to show when overload resolution fails: best|all; defaults to all")
            (",fsjlj-exceptions","         Use SjLj style exceptions")
            (",fsyntax-only","             Run parser and perform semantic analysis")
            (",ftabstop",value(&m_ftabstop),"   <N>           Set the tab stop distance.")
            (",ftemplate-backtrace-limit",value(&m_ftemplate_backtrace_limit),"   <N>                          Set the maximum number of entries to print in a template instantiation backtrace (0 = no limit).")
            (",ftemplate-depth",value(&m_ftemplate_depth),"   <value>                          Maximum depth of recursive template instantiation")
            ...
            (",fvisibility",value(&m_fvisibility),"   <value>    Default symbol visibility")
            (",fwrapv","                   Treat signed integer overflow as two's complement")
            (",fwritable-strings","        Store string literals as writable data")
            (",g","                        Generate source level debug information")
            (",header-include-file",value(&m_header_include_file),"   <value>                          Filename (or -) to write header include output to")
            (",help","                     Print this help text")
            (",idirafter",value(&m_idirafter),"   <directory>  Add directory to AFTER include search path")
            (",iframework",value(&m_iframework),"   <directory> Add directory to SYSTEM framework search path")
            (",imacros",value(&m_imacros),"   <file>         Include macros from file before parsing")
            (",include-pch",value(&m_include_pch),"   <file>     Include precompiled header file")
            (",include-pth",value(&m_include_pth),"   <file>     Include file before parsing")
            (",include",value(&m_include),"   <file>         Include file before parsing")
            (",index-header-map","         Make the next included directory (-I or -F) an indexer header map")
            (",init-only","                Only execute frontend initialization")
            (",internal-externc-isystem",value(&m_internal_externc_isystem),"   <directory>                          Add directory to the internal system include search path with implicit extern "C" semantics; these are assumed to not be user-provided and are used to model system and standard headers' paths.")
            (",internal-isystem",value(&m_internal_isystem),"   <directory>                          Add directory to the internal system include search path; these are assumed to not be user-provided and are used to model system and standard headers' paths.")
            (",iprefix",value(&m_iprefix),"   <prefix>       Set the -iwithprefix/-iwithprefixbefore prefix")
            (",iquote",value(&m_iquote),"   <directory>     Add directory to QUOTE include search path")
            (",isysroot",value(&m_isysroot),"   <dir>         Set the system root directory (usually /)")
            (",isystem",value(&m_isystem),"   <directory>    Add directory to SYSTEM include search path")
            (",iwithprefixbefore",value(&m_iwithprefixbefore),"   <dir>                          Set directory to include search path with prefix")
            (",iwithprefix",value(&m_iwithprefix),"   <dir>      Set directory to SYSTEM include search path with prefix")
            (",iwithsysroot",value(&m_iwithsysroot),"   <directory>                          Add directory to SYSTEM include search path, absolute paths are relative to -isysroot")
            (",load",value(&m_load),"   <dsopath>         Load the named plugin (dynamic shared object)")
            (",main-file-name",value(&m_main_file_name),"   <value> Main file name to use for debug info")
            (",masm-verbose","             Generate verbose assembly output")
            (",mcode-model",value(&m_mcode_model),"   <value>    The code model to use")
            (",mconstructor-aliases","     Emit complete constructors and destructors as aliases when possible")
            (",mdebug-pass",value(&m_mdebug_pass),"   <value>    Enable additional debug output")
            ...
            (",mfloat-abi",value(&m_mfloat_abi),"   <value>     The float ABI to use")
            (",migrate","                  Migrate source code")
            (",mlimit-float-precision",value(&m_mlimit_float_precision),"   <value>                          Limit float precision to the given value")
            (",mlink-bitcode-file",value(&m_mlink_bitcode_file),"   <value>                          Link the given bitcode file before performing optimizations.")
            (",mllvm",value(&m_mllvm),"   <value>          Additional arguments to forward to LLVM's option processing")
            ...
            (",mregparm",value(&m_mregparm),"   <value>       Limit the number of registers available for integer arguments")
            (",mrelax-all","               (integrated-as) Relax all machine instructions")
            (",mrelocation-model",value(&m_mrelocation_model),"   <value>                          The relocation model to use")
            (",mrtd","                     Make StdCall calling convention the default")
            (",msave-temp-labels","        (integrated-as) Save temporary labels")
            (",msoft-float","              Use software floating point")
            (",mstack-alignment",value(&m_mstack_alignment),"                            Set the stack alignment")
            (",mstackrealign","            Force realign the stack at entry to every function.")
            (",mt-migrate-directory",value(&m_mt_migrate_directory),"   <value>                          Directory for temporary files produced during ARC or ObjC migration")
            ...
            (",objc-isystem",value(&m_objc_isystem),"   <directory>                          Add directory to the ObjC SYSTEM include search path")
            (",objcxx-isystem",value(&m_objcxx_isystem),"   <directory>                          Add directory to the ObjC++ SYSTEM include search path")
            (",o",value(&m_o),"   <path>               Specify output file")
            (",pg","                       Enable mcount instrumentation")
            (",pic-level",value(&m_pic_level),"   <value>      Value for __PIC__")
            (",plugin-arg",value(&m_plugin_arg),"   <arg>                          Pass <arg> to plugin <name>")
            (",plugin",value(&m_plugin),"   <name>          Use the named plugin action instead of the default action (use "help" to list available options)")
            (",preamble-bytes",value(&m_preamble_bytes),"   Assume that the precompiled header is a precompiled preamble covering the first N bytes of the main file")
            ...
            (",remap-file",value(&m_remap_file),"   <from>;<to> Replace the contents of the <from> file with the contents of the <to> file")
            (",resource-dir",value(&m_resource_dir),"   <value>   The directory which holds the compiler resource files")
            ...
            (",serialize-diagnostic-file",value(&m_serialize_diagnostic_file),"   <filename>                          File for serializing diagnostics in a binary format")
            (",stack-protector",value(&m_stack_protector),"   <value>                          Enable stack protectors")
            (",static-define","            Should __STATIC__ be defined")
            (",std",value(&m_std),"              Language standard to compile for")
            (",stdlib",value(&m_stdlib),"           C++ standard library to use")
            (",sys-header-deps","          Include system headers in dependency output")
            (",target-abi",value(&m_target_abi),"   <value>     Target a particular ABI type")
            (",target-cpu",value(&m_target_cpu),"   <value>     Target a specific cpu type")
            (",target-feature",value(&m_target_feature),"   <value> Target specific attributes")
            (",target-linker-version",value(&m_target_linker_version),"   <value>                          Target linker version")
            (",token-cache",value(&m_token_cache),"   <path>     Use specified token cache file")
            (",traditional-cpp","          Enable some traditional CPP emulation")
            (",trigraphs","                Process trigraph sequences")
            (",trim-egraph","              Only show error-related paths in the analysis graph")
            (",triple",value(&m_triple),"   <value>         Specify target triple (e.g. i686-apple-darwin9)")
